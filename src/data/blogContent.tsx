...
const WizardCta = ({ variant = "light" }: { variant?: "light" | "dark" }) => (
  <div className={`rounded-lg p-6 not-prose ${variant === "dark" ? "bg-navy text-white" : "bg-light-blue"}`}>
    <p className="font-semibold text-sm mb-2">
      {variant === "dark" ? "Prêt à passer à l'action ?" : "Découvrez vos options personnalisées"}
    </p>
    <p className={`text-xs mb-3 ${variant === "dark" ? "text-white/50" : "text-dark/50"}`}>
      Notre wizard gratuit analyse votre situation en 5 minutes et vous connecte aux meilleurs courtiers.
    </p>
    <Link href="/wizard" className="inline-block bg-primary text-white px-5 py-2 rounded-md text-sm font-semibold hover:bg-primary-dark transition">
...
export const blogContentMap: Record<string, React.ReactNode> = {
  ...
  "hypotheque-immigrants-canada-guide": (
    <>
      ...
      <h2 className="text-xl font-bold text-navy">Le programme SCHL Nouveaux Arrivants</h2>
      <p>
      ...
      <h2 className="text-xl font-bold text-navy">Le crédit alternatif : pas besoin d&apos;historique canadien</h2>
      <p>
      ...
      <h2 className="text-xl font-bold text-navy">Les 6 grandes banques et leurs programmes</h2>
      ...
      <h2 className="text-xl font-bold text-navy">Le stress test hypothécaire</h2>
      <p>
      ...
      <h2 className="text-xl font-bold text-navy">L&apos;assurance SCHL : primes par ratio prêt-valeur</h2>
      ...
      <h2 className="text-xl font-bold text-navy">Points importants à savoir</h2>
      <ul className="space-y-2">
  ...
  "hypotheque-permis-travail": (
    <>
      ...
      <h2 className="text-xl font-bold text-navy">Conditions spécifiques pour les travailleurs temporaires</h2>
      <ul className="space-y-2">
      ...
      <h2 className="text-xl font-bold text-navy">Programmes bancaires pour travailleurs temporaires</h2>
      <ul className="space-y-2">
      ...
      <h2 className="text-xl font-bold text-navy">Restriction importante</h2>
      <p>
  ...
  "hypotheque-residence-permanente": (
    <>
      ...
      <h2 className="text-xl font-bold text-navy">Avantages du statut RP</h2>
      <ul className="space-y-2">
      ...
      <h2 className="text-xl font-bold text-navy">Ce que les banques offrent aux RP</h2>
      <ul className="space-y-2">
      ...
      <h2 className="text-xl font-bold text-navy">Amortissement 30 ans (nouveau 2024)</h2>
      <p>
  ...
  "hypotheque-quebec": (
    <>
      ...
      <h2 className="text-xl font-bold text-navy">Desjardins : votre allié au Québec</h2>
      <p>
      ...
      <h2 className="text-xl font-bold text-navy">Particularités du Québec</h2>
      <ul className="space-y-2">
      ...
      <h2 className="text-xl font-bold text-navy">Marché immobilier québécois</h2>
      <p>
  ...
  "combien-emprunter": (
    <>
      ...
      <h2 className="text-xl font-bold text-navy">Les ratios d&apos;endettement SCHL</h2>
      ...
      <h2 className="text-xl font-bold text-navy">Exemple concret</h2>
      <p>
      ...
      <h2 className="text-xl font-bold text-navy">Le stress test</h2>
      <p>
      ...
      <h2 className="text-xl font-bold text-navy">Ce qui est inclus / exclu</h2>
      <ul className="space-y-2">
  ...
  "documents-hypotheque": (
    <>
      ...
      <h2 className="text-xl font-bold text-navy">1. Documents d&apos;identité</h2>
      ...
      <h2 className="text-xl font-bold text-navy">2. Preuves de revenus</h2>
      <ul className="space-y-1">
      ...
      <h2 className="text-xl font-bold text-navy">3. Documents financiers</h2>
      <ul className="space-y-1">
      ...
      <h2 className="text-xl font-bold text-navy">4. Crédit alternatif (si pas de crédit canadien)</h2>
      ...
      <h2 className="text-xl font-bold text-navy">5. Documents pour la propriété</h2>
      <ul className="space-y-1">
  ...
  "banques-hypotheque": (
    <>
      ...
      <h2 className="text-xl font-bold text-navy">RBC — Programme Welcome to Canada</h2>
      <ul className="space-y-1">
      ...
      <h2 className="text-xl font-bold text-navy">TD — Programme Nouveaux Arrivants</h2>
      <ul className="space-y-1">
      ...
      <h2 className="text-xl font-bold text-navy">Scotiabank — StartRight</h2>
      <ul className="space-y-1">
      ...
      <h2 className="text-xl font-bold text-navy">BMO — Programme NewStart</h2>
      <ul className="space-y-1">
      ...
      <h2 className="text-xl font-bold text-navy">CIBC — 3 programmes distincts</h2>
      <ul className="space-y-1">
      ...
      <h2 className="text-xl font-bold text-navy">Desjardins — Spécialiste Québec</h2>
      <ul className="space-y-1">
  ...
  "mauvais-credit": (
    <>
      ...
      <h2 className="text-xl font-bold text-navy">Score minimum : 600</h2>
      <p>
      ...
      <h2 className="text-xl font-bold text-navy">Options avec crédit faible</h2>
      <ul className="space-y-2">
      ...
      <h2 className="text-xl font-bold text-navy">Améliorer votre score rapidement</h2>
      <ul className="space-y-2">
  ...
  "sans-historique-credit": (
    <>
      ...
      <h2 className="text-xl font-bold text-navy">Crédit alternatif accepté par la SCHL</h2>
      <p>
      ...
      <h2 className="text-xl font-bold text-navy">Banques qui n&apos;exigent PAS de crédit canadien</h2>
      <ul className="space-y-2">
        <li><strong>TD :</strong> Pas de crédit canadien requis pour RP de 5 ans et moins</li>
      ...
      <h2 className="text-xl font-bold text-navy">Bâtir votre crédit en parallèle</h2>
      <p>
